...
Setting up a build environemtn, including the required software tools, and compiling the source code is detailed in the `VISR API documentation <http://s3a-spatialaudio.org>`_.

.. todo:: Add link to web version of apidoc-html
