#SET(CMAKE_INSTALL_PREFIX get_filename_component(result “.” ABSOLUTE))
...
INSTALL( FILES ${SNDFILE_LIBRARY_DIR}/libsndfile-1.dll DESTINATION bin )
...
IF( Boost_USE_STATIC_LIBS )
  ...
  INSTALL( FILES ${Boost_LIBRARY_DIR_RELEASE}/${BOOST_CHRONO_LIBRARY_BASENAME}.dll DESTINATION bin )
  INSTALL( FILES ${Boost_LIBRARY_DIR_RELEASE}/${BOOST_DATE_TIME_LIBRARY_BASENAME}.dll DESTINATION bin )
  INSTALL( FILES ${Boost_LIBRARY_DIR_RELEASE}/${BOOST_FILESYSTEM_LIBRARY_BASENAME}.dll DESTINATION bin )
  INSTALL( FILES ${Boost_LIBRARY_DIR_RELEASE}/${BOOST_PROGRAM_OPTIONS_LIBRARY_BASENAME}.dll DESTINATION bin )
  INSTALL( FILES ${Boost_LIBRARY_DIR_RELEASE}/${BOOST_SYSTEM_LIBRARY_BASENAME}.dll DESTINATION bin )
  INSTALL( FILES ${Boost_LIBRARY_DIR_RELEASE}/${BOOST_THREAD_LIBRARY_BASENAME}.dll DESTINATION bin )
  INSTALL( FILES ${Boost_LIBRARY_DIR_RELEASE}/${BOOST_CHRONO_LIBRARY_BASENAME}.dll DESTINATION bin )
ELSE()
...
IF( VISR_SYSTEM_NAME MATCHES "MacOS" )
  ...
  # SET( CPACK_BUNDLE_STARTUP_COMMAND baseline_renderer )  
  INSTALL( FILES ${PORTAUDIO_LIBRARIES} DESTINATION bin)
  INSTALL( FILES ${SNDFILE_LIBRARY} DESTINATION bin)  
