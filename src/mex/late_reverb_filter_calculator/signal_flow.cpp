                     ...
                     LateFilterMessageQueue & outputQueue )
{
  ...
  mDecoder.process(); // XXX Will not work at the moment.
  // TODO: Provide signal flow encapsulation with external ports.
  ...
  mCalc.process(); // XXX Will not work at the moment.
}
