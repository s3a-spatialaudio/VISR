...
void exportLoudspeakerArray( pybind11::module & m)
{
  pybind11::class_<LoudspeakerArray>(m, "LoudspeakerArray")
    ...
    .def("getGainAdjustments", &LoudspeakerArray::getGainAdjustment, pybind11::return_value_policy::reference )
    .def("getDelayAdjustments", &LoudspeakerArray::getDelayAdjustment, pybind11::return_value_policy::reference )
