# Compress any positive height (above) component of all objects
...
class CompressAboveProcessor(SequenceProcessorInterface):
	...
	def setParameter( self, key, valueList ):
		...
		if (key == "active"):
			if len( valueList ) != 1:
				raise KeyError( "CompressAboveProcessor command \"active\" must contain 1 value." )
