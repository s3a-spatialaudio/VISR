...
#ifndef VISR_PYTHON_EFL_CONTAINER_HELPERS_HPP_INCLUDED
#define VISR_PYTHON_EFL_CONTAINER_HELPERS_HPP_INCLUDED
...
#endif // VISR_PYTHON_EFL_CONTAINER_HELPERS_HPP_INCLUDED