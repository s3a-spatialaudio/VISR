...
#include <librcl/parameter_output_terminator.hpp>
...
void exportParameterOutputTerminator( py::module & m )
{
  using visr::rcl::ParameterOutputTerminator;

  py::class_<visr::rcl::ParameterOutputTerminator,
    visr::AtomicComponent >( m, "ParameterOutputTerminator" )
