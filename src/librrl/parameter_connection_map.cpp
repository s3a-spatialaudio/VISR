                    ...
                    std::ostream & messages )
{
  ...
  for( auto port : composite.Component::implementation().ports<ParameterPortBase>() )
  {
  ...
  for( impl::ParameterConnectionTable::const_iterator connIt = compositeImpl.parameterConnectionBegin();
