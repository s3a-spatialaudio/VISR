...
template<>
efl::ErrorCode FftwWrapper<float>::forwardTransform( float const * const in, std::complex<float> * out ) const
{
...
template<>
efl::ErrorCode FftwWrapper<float>::inverseTransform( std::complex<float> const * const in, float * out ) const
{
...
template<>
efl::ErrorCode FftwWrapper<double>::forwardTransform( double const * const in, std::complex<double> * out ) const
{
...
template<>
efl::ErrorCode FftwWrapper<double>::inverseTransform( std::complex<double> const * const in, double * out ) const
{
