...
public:
   ...
   */
  explicit InterpolatingConvolverUniform( std::size_t numberOfInputs,
...
private:
   ...
   * These are not directly used in the convolution, but are the input arguments of the interpolation.
   */
