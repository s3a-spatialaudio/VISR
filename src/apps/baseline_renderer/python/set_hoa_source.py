...
parser.add_argument( "order", help="The object id, an integer >= 0." )
...
msg = "{ \"objects\":[{\"id\": %d, \"order\": %d, \"channels\": %s, \"type\": \"hoa\", \"group\": %d, \"priority\": %d, \"level\": %f}]  }" % ( objectId, order, channelId, groupId, priority, level )
