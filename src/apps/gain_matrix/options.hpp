...
#ifndef VISR_APPS_GAIN_MATRIX_OPTIONS_HPP_INCLUDED
#define VISR_APPS_GAIN_MATRIX_OPTIONS_HPP_INCLUDED
 ...
 * @todo Move to a library, replace several instances (e.g., in apps::baseline_renderer)
 */
class Options
{
public:
...
#endif // #ifndef VISR_APPS_GAIN_MATRIX_OPTIONS_HPP_INCLUDED
