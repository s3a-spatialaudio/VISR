 ...
 : apputilities::Options()
{
  ...
  registerOption<std::string>( "metadapter-config,m", "Metadapter configuration file. Requires a build with Python support. If empty, no metadata adaptation is performed." );
