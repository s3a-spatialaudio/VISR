...
Options::Options()
{
  ...
  registerOption<std::string>( "module-search-path,d", "Optional path to search for the Python module (in addition to the default search path (sys.path incl. $PYTHONPATH)." );
