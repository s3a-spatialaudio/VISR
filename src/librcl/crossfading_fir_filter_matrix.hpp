...
#ifndef VISR_LIBRCL_CROSSFADING_FIR_FILTER_MATRIX_HPP_INCLUDED
#define VISR_LIBRCL_CROSSFADING_FIR_FILTER_MATRIX_HPP_INCLUDED
...
class CrossfadingConvolverUniform;
}
 ...
 */
class VISR_RCL_LIBRARY_SYMBOL CrossfadingFirFilterMatrix: public AtomicComponent
{
...
public:
   ...
   * @param transitionSamples duration of a crossfade (as number of samples)
   ...
   */
  explicit CrossfadingFirFilterMatrix( SignalFlowContext const & context,
                            char const * name,
...
private:
  ...
  std::unique_ptr<rbbl::CrossfadingConvolverUniform<SampleType> > mConvolver;
};

/**
 * Bitwise operator to combine control input flags.
 */
VISR_RCL_LIBRARY_SYMBOL CrossfadingFirFilterMatrix::ControlPortConfig operator|( CrossfadingFirFilterMatrix::ControlPortConfig lhs,
...
#endif // #ifndef VISR_LIBRCL_CROSSFADING_FIR_FILTER_MATRIX_HPP_INCLUDED
