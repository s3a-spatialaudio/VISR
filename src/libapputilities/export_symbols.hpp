...
#ifdef VISR_BUILD_APPUTILITIES_SHARED_LIBRARY
...
#endif // #ifdef VISR_BUILD_APPUTILITIES_LIBRARIES
...
#else // VISR_BUILD_APPUTILITIES_SHARED_LIBRARY

#define VISR_APPUTILITIES_LIBRARY_SYMBOL // expand to empty string

#endif // VISR_BUILD_APPUTILITIES_SHARED_LIBRARY
