...
{
  if( checkAlignment( src, alignmentElements ) ) return efl::alignmentError;
  if( checkAlignment( dest, alignmentElements ) ) return efl::alignmentError;
...
{
  if( checkAlignment( dest, alignmentElements ) ) return alignmentError;
