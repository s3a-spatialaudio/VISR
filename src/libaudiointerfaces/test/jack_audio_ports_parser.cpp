...
//                numberOfSources =4;
//                audiointerfaces::JackInterface::Config interfaceConfig;
//                load(interfaceConfig,defConfig);
//                std::cout <<"Capture ports : \t[ ";
//                for (auto i: interfaceConfig.mCapturePortNames)
//                    std::cout << i << "\t";
//                std::cout <<']'<<std::endl;
...
//               
                ...
                std::unique_ptr<rrl::AudioInterface> audioInterface = AudioInterfaceFactory::create( "JACK", baseConfig, defSpecConfig);
...
//                audiointerfaces::JackInterface audioInterface( baseConfig, interfaceConfig);
                ...
                //                std::cout<<interfaceConfig.mCapturePortNames.size()<<" : "<<numberOfObjects<<std::endl;
...
//                std::cout<<"FLOW: "<<flow.externalParameterReceiveEndpoints().at(0)<<std::endl;
